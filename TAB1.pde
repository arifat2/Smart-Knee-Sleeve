void TAB_1() {
  ...
  image(imgs, 0, 0, imgs.width - 100, imgs.height - 100);

  // title
  textAlign(CENTER, CENTER);
  textFont(createFont("Impact", 60));
  fill(255);
  text("Squat Exercise", width/2, 50);
...
void KneeMovement2() {
  ...
  fill(62, 218, 121);
  stroke(62, 218, 121);
  rect(width/2 + 140, height/2 + 25, 140, 5);
